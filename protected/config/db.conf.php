...
$dbmap['Post']['has_many']['User'] = array('foreign_key'=>'post_id', 'through'=>'post_user');
$dbmap['User']['has_many']['Post'] = array('foreign_key'=>'user_id', 'through'=>'post_user');

$dbmap['Post']['has_many']['Comment'] = array('foreign_key'=>'post_id');
$dbmap['Comment']['belongs_to']['Post'] = array('foreign_key'=>'id');

$dbmap['User']['has_many']['Comment'] = array('foreign_key'=>'user_id');
$dbmap['Comment']['belongs_to']['User'] = array('foreign_key'=>'id');
