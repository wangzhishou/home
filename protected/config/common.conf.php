 ...
 * Please refer to Config class in the API doc for a complete list of configurations
 * Access via Singleton, eg. Q::conf()->BASE_PATH;
 */
...
$config['SITE_PATH'] = realpath('..').'/home/';
//$config['PROTECTED_FOLDER'] = 'protected/';
$config['BASE_PATH'] = realpath('..').'/framework/';
